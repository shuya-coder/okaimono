...
- 履歴の商品を商品単位で蓄積し、リストへ簡単に再追加
- 履歴の商品を商品名とカテゴリーでリアルタイム絞り込み
- 履歴の商品を最終購入順、あいうえお順、古いもの順、購入頻度順で並び替え
- カテゴリー名と色を編集
- CSVでデータをバックアップ、復元
- ダークモード切替
- LocalStorage初期化
...
会計済みにした商品はカートから消え、履歴へ保存されます。同じ商品は1件にまとめられ、再度購入すると一覧の先頭へ移動します。

### 履歴の商品を再追加する

`📜 履歴` タブでは、以前購入した商品を確認し、`＋ リストへ` で個数1として買い物リストへ追加できます。すでにリストにある商品は個数が1増えます。
