...
- カートの商品数を増減
- カートの商品を削除
- カート内の商品を会計済みにして購入済み商品へ保存
- 購入済み商品を商品単位で蓄積し、リストへ簡単に再追加
- 購入済み商品を商品名とカテゴリーでリアルタイム絞り込み
- カテゴリー名と色を編集
- CSVでデータをバックアップ、復元
- ダークモード切替
- LocalStorage初期化
...
買い物リスト、カート、購入済み商品、カテゴリーを移す場合はCSVを使います。
...
会計済みにした商品はカートから消え、購入済み商品へ保存されます。同じ商品は1件にまとめられ、再度購入すると一覧の先頭へ移動します。

### 購入済み商品を再追加する

`🧺 購入済み` タブでは、以前購入した商品を確認し、`＋ リストへ` で個数1として買い物リストへ追加できます。すでにリストにある商品は個数が1増えます。
...
- `js/history.js`: 購入済み商品の蓄積、更新、旧履歴データの移行
